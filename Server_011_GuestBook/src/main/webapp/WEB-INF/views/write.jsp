...
document.addEventListener("DOMContentLoaded",function() {
	...
	document.querySelector("button.btn_home").addEventListener("click",function(e){
...
<body>
	...
	<form class="v1" method="POST">
		...
		<div>
			<label style="position: relative; top: -85px;">내용</label>
			<textarea style="resize: vertical; min-height: 100px;" name="gb_content" rows="5">${GB.gb_content}</textarea>
		</div>
