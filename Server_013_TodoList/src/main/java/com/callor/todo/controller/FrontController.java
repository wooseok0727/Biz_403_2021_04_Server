 ...
 * 다수 선언하고, 필요할때마다 URI(URL)을 mapping
 * 기능을 수행할 수 있도록 한다
 * 
 * 하지만
 ...
 * POJO
 * (Plain Old Java Object, 어떤 클래스를 상속받지 않은 
...
public class FrontController extends HttpServlet {
	...
	private static final long serialVersionUID = -9128124603090986908L;
	protected Map<String, TodoCommand> commands;
	
	
	// FrontContorller가 최초 호출될 때
	// 한번 실행되어서
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String path = uriPath.substring(req.getContextPath().length());
