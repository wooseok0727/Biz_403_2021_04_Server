...
public class HomeController {
	 ...
	 * 		필요한 method를 호출할 수 있도록 만들어준다
	 * 
	 * 하지만 Spring Framework 환경에서는
	 ...
	 * 
	 * Spring framework 환경에서는 
	 * 		그러한 것들을 극복하기 위하여
	 * 		미리 객체를 만들어서 Spring 컨테이너 라는 곳에
	 * 		보관해 두고
	 * 		필요한 곳에 적절히 주입을 해준다
	 * 
	 * 		이러한 개념을 DI(Dependency Inject : 의존성 주입)라고 하며
	 * 		전통 방식과 반대되는 개념이어서 제어의 역전(IoC : Inversion of Control )라고 부른다
	 * 		
	 * 		
	 * 		
	 * 
